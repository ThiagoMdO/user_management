...
class UserServiceTests {
    ...
    @Test
    @DisplayName("create: UserRequestValidFields_WithoutRole > ReturnsUserResponseCreatedDTO")
    ...
    @Test
    @DisplayName("create: UserRequestValidFields_WithRoleADM_AND_COMMON > ReturnsUserResponseCreateDTO")
